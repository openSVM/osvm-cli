...
**Total Content:** ~120,000 words across 16 chapters (13 original + 3 NEW foundational chapters)
...
| Chapter | Title | Words | Topics |
|---------|-------|-------|--------|
| [15](15_pumpswap_sniping.md) | Decentralized Exchange Sniping & MEV | 8,120 | Black Thursday, rug pulls, Jito bundles, risk management |
