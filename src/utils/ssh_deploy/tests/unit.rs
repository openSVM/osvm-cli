...
mod tests {
    use {
        crate::utils::ssh_deploy::{
            types::{NetworkType, ServerConfig, DeploymentConfig, AuthMethod},
            ...
            services::{
                create_docker_service_content,
                create_binary_service_content,
            },
        },
    ...
    fn test_network_type_from_str() {
        ...
        assert_eq!(NetworkType::from_str("devnet").unwrap(), NetworkType::Devnet);
    ...
    fn test_get_required_resources() {
        ...
        assert_eq!(get_required_resources("solana", "validator").unwrap(), (12, 128, 2048));
        assert_eq!(get_required_resources("solana", "rpc").unwrap(), (16, 256, 4096));
        assert_eq!(get_required_resources("sonic", "validator").unwrap(), (8, 32, 1024));
        assert_eq!(get_required_resources("sonic", "rpc").unwrap(), (16, 64, 2048));
        assert_eq!(get_required_resources("sui", "validator").unwrap(), (8, 32, 1024));
        assert_eq!(get_required_resources("sui", "rpc").unwrap(), (16, 64, 2048));
        assert_eq!(get_required_resources("aptos", "validator").unwrap(), (8, 32, 1024));
        assert_eq!(get_required_resources("aptos", "rpc").unwrap(), (16, 64, 2048));
