use osvm_cli::services::unikernel_runtime::{
    UnikernelConfig, UnikernelLauncher, UnikernelRuntime,
};
...
async fn test_vsock_port_constant() {
    ...
    assert_eq!(VSOCK_PORT, 5252, "Vsock port must be 5252 for Phase 2/3 compatibility");
}
