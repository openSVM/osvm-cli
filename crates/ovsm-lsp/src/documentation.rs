...
static DOCUMENTATION: LazyLock<HashMap<&'static str, DocEntry>> = LazyLock::new(|| {
    ...
    docs.insert("progn", DocEntry {
        signature: "(progn expr1 expr2 ... exprN)",
        description: "Alias for `do`. Evaluates expressions in sequence and returns the last value.",
        examples: &[
            "(progn (define x 1) (+ x 1))",
        ],
        category: DocCategory::SpecialForm,
    });
    ...
    docs.insert("while", DocEntry {
        signature: "(while condition body...)",
        description: "Executes body expressions repeatedly while condition is true. Returns null.",
        examples: &[
            "(while (< i 10) (log :value i) (set! i (+ i 1)))",
        ],
        category: DocCategory::ControlFlow,
    });

    docs.insert("for", DocEntry {
    ...
    docs.insert("unless", DocEntry {
        signature: "(unless condition body...)",
        description: "Executes body expressions only if condition is false. Opposite of `when`.",
        examples: &[
            "(unless (null? data) (process data))",
        ],
        category: DocCategory::ControlFlow,
    });
    ...
    docs.insert("=", DocEntry {
        signature: "(= val1 val2)",
        description: "Equality comparison. In OVSM LISP, `=` is used for comparison (not assignment).",
        examples: &[
            "(= 1 1)       ;; => true",
            "(= \"a\" \"b\") ;; => false",
        ],
    ...
    docs.insert("and", DocEntry {
        signature: "(and expr1 expr2 ...)",
        description: "Logical AND. Short-circuits: returns first false value or the last value.",
        examples: &[
            "(and true true)   ;; => true",
    ...
    docs.insert("positivep", DocEntry {
    ...
    docs.insert("negativep", DocEntry {
    ...
    docs.insert("mapcar", DocEntry {
        signature: "(mapcar function list)",
        description: "Applies function to each element of list, returning a new list of results.",
        examples: &[
    ...
    docs.insert("sin", DocEntry {
        signature: "(sin radians)",
        description: "Returns the sine of angle in radians.",
        examples: &[
            "(sin 0)      ;; => 0",
            "(sin 1.571)  ;; => 1 (approx pi/2)",
        ],
        category: DocCategory::Math,
    });

    docs.insert("cos", DocEntry {
    ...
    docs.insert("bool", DocEntry {
        signature: "(bool value)",
        description: "Converts value to boolean. Null, 0, false, empty string are false; all else true.",
        examples: &[
            "(bool 0)       ;; => false",
            "(bool 1)       ;; => true",
            "(bool \"\")     ;; => false",
    ...
    docs.insert("log", DocEntry {
        signature: "(log :message msg) or (log :value val)",
        description: "Logs a message or value to the console. Use keyword arguments :message or :value.",
        examples: &[
            "(log :message \"Hello\")",
            "(log :value x)",
