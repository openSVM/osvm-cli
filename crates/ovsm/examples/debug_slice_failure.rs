    ...
    for i in 0..e_shnum {
        ...
        if sh_type == 6 { // SHT_DYNAMIC
            ...
            if sh_size % entry_size != 0 {
                ...
                println!("     {} % {} = {}", sh_size, entry_size, sh_size % entry_size);
                return;
            } else {
                println!("  ✅ Size is divisible by {} (entries = {})", entry_size, sh_size / entry_size);
            }
            ...
            if (ptr as usize) % alignment != 0 {
                ...
                println!("     ptr=0x{:x}, alignment={}, remainder={}",
                        ptr as usize, alignment, (ptr as usize) % alignment);
                return;
            } else {
                println!("  ✅ Pointer is aligned (ptr=0x{:x}, alignment={})", ptr as usize, alignment);
            }
