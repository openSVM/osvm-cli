...
osvm - program to do something

# SYNOPSIS

**osvm** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**osvm** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **osvm** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**osvm** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    osvm. See **foo.conf**(5) for further details.
...
**osvm** provides some return codes, that can be used in scripts:
...
OpenSVM <rin@opensvm.com>
:   Wrote this manpage for the Debian system.

# COPYRIGHT

Copyright © 2007 OpenSVM
